...
urlpatterns = [
    ...
    path('delete_collection_item/<int:collection_item_id>', views.delete_collection_item, name='delete_collection_item'),
    ...
    path('get_all_bottle_caps_by_collection/<int:collection_id>/', views.get_all_bottle_caps_by_collection, name='get_all_bottle_caps_by_collection'),
